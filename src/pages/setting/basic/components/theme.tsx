...
type Props = SettingState & {
	setThemeType: (val: ThemeType | "custom") => CustomActionType;
				...
				<Flex vertical style={{ width: "100%" }}>
					...
					<ColorPicker
						...
						onChangeComplete={color => {
							console.log({ ...customThemeData, primaryColor: color.toHexString() });

							setCustomThemeData({ ...customThemeData, primaryColor: color.toHexString() });
						}}
					/>
					<div>132</div>
					<div>132</div>
